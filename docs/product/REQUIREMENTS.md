...
**Version:** 1.6
**Date:** 2026-08-16 (rev. 1.6 — PD-099 concurrency sub-decision approved: FR-PKG-08 updated)
...
| FR-PKG-08 | **Where several grants coexist, entitlement resolution is deterministic and server-side.** **Concurrency is resolved as an account-level pool: the effective commercial allowance is the MAXIMUM applicable grant allowance, not the sum** *(PD-099 concurrency sub-decision APPROVED)*, and independent constraints — including rights-agreement concurrency limits — remain authoritative. The **remaining** resolution rules are **[OPEN — PD-099]**. | **P0** |
