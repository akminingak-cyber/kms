...
| `drm-license-proxy/` | Separate service | **Security isolation.** The only workload with key-vault credentials | 6 |
...
| `telemetry-collector/` | High-write intake | Write volume orders of magnitude above everything else; must be droppable under load | 10 |
