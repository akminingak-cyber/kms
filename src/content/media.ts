...
export const MEDIA: Record<string, MediaSlot> = {
  ...
  'industry:corporate': {
    ...
    alt: {
      ka: 'საოფისე სართული მინის ტიხრებით და სამუშაო ადგილებით',
      en: 'An office floor with glazed partitions and workstations',
    },
    ratio: '4/3',
  },
  ...
  'industry:industrial': {
    ...
    alt: {
      ka: 'საწარმოო ცეხი — დანადგარების რიგები და ღია საინჟინრო კომუნიკაციები',
      en: 'A production hall — rows of machinery and exposed building services',
    },
    ratio: '4/3',
  },
  'industry:government': {
