...
export const MEDIA: Record<string, MediaSlot> = {
  ...
  heroDiagram: {
    ...
    alt: {
      ka: 'თანამედროვე საოფისე შენობა შებინდებისას — განათებული სართულები მინის ფასადს მიღმა და სველი მოედანი წინ',
      en: 'A modern office building at dusk — lit floors behind a glazed facade above a wet plaza',
    },
    ratio: '4/3',
  },
  ...
  smartPhoto: {
    ...
    alt: {
      ka: 'მისაღები ოთახი და კედელზე დამონტაჟებული მართვის პანელი — განათება, ფარდები, კლიმატი და დაცვა ერთ ეკრანზე',
      en: 'A living room beside a wall-mounted control panel — lighting, blinds, climate and security on one screen',
    },
    ratio: '4/3',
  },
  ...
  'service:it-infrastructure': {
    ...
    alt: {
      ka: 'სერვერული ოთახის დერეფანი — გახსნილი კარადა კომუტატორებით და მოწესრიგებული პაჩ-კაბელებით',
      en: 'A server room aisle — an open cabinet with switches and dressed patch leads',
    },
    ratio: '4/3',
  },
  'service:networking': {
    ...
    alt: {
      ka: 'ორი პაჩ-პანელი დანომრილი პორტებით — ყველა პორტში ლურჯი კაბელი, თანაბარი მარყუჟებით გაყვანილი',
      en: 'Two patch panels with numbered ports — every port populated, the leads dressed in identical loops',
    },
    ratio: '4/3',
  },
  'service:cctv': {
    ...
    alt: {
      ka: 'ვიდეოკამერა ბეტონის სვეტზე, დაცულ კაბელგაყვანილობასთან, ღია საოფისე სივრცის ხედით',
      en: 'A camera on a concrete column beside protected cabling, overlooking an open office floor',
    },
    ratio: '4/3',
  },
  ...
  'service:smart-home': {
    ...
    alt: {
      ka: 'ჭკვიანი სახლის მართვის პანელი კედელზე — დაცვა, კლიმატი, განათება და სცენარები ერთ ეკრანზე',
      en: 'A wall-mounted smart home panel — security, climate, lighting and scenes on one screen',
    },
    ratio: '4/3',
  },
  'service:smart-building': {
    ...
    alt: {
      ka: 'შენობის საინჟინრო სისტემები ჭერქვეშ — ვენტილაციის არხები, კაბელგატარი და სახანძრო მილგაყვანილობა',
      en: 'Building services beneath the slab — ventilation ducts, cable containment and fire-main pipework',
    },
    ratio: '4/3',
  },
  'service:audio-visual': {
    ...
    alt: {
      ka: 'სათათბირო ოთახი — დიდი ეკრანი, ვიდეო-პანელი მის ქვეშ და მაგიდის საკონფერენციო მოწყობილობა',
      en: 'A meeting room — a large display, a video bar beneath it and a tabletop conferencing unit',
    },
    ratio: '4/3',
  },
  'service:managed-it': {
  ...
  'industry:hospitality': {
    ...
    alt: {
      ka: 'სასტუმროს ნომერი შებინდებისას — თბილი განათება და ქალაქის ხედი ფანჯარაში',
      en: 'A hotel room at dusk — warm lamp light and a city view through the window',
    },
    ratio: '4/3',
  },
  'industry:education': {
  ...
  'industry:residential': {
    ...
    alt: {
      ka: 'თანამედროვე ვილა შებინდებისას — განათებული ინტერიერი და აუზი, რომელშიც ფასადი აირეკლება',
      en: 'A contemporary villa at dusk — lit interior and a pool mirroring the facade',
    },
    ratio: '4/3',
  },
};
